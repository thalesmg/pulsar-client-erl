...
-record(lookup_topic, {partition_topic :: partition_topic()}).
...
lookup_topic(ClientId, PartitionTopic, Timeout) ->
    gen_server:call(ClientId, #lookup_topic{partition_topic = PartitionTopic}, Timeout).
...
handle_call(#get_topic_metadata{topic = Topic}, _From, State0) ->
    ...
    {reply, Reply, State};
handle_call(#lookup_topic{partition_topic = PartitionTopic}, From, State0) ->
